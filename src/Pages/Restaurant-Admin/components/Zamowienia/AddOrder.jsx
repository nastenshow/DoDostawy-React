...
import MapBoxComponentRoute from "../../../Admin-DoDostawy/components/Map/MapBoxComponentRoute.jsx";
import CitySelector from "../../../Admin-DoDostawy/components/Map/CitySelector.jsx";

import axios from "axios";

import StreetSelector from "../../../Admin-DoDostawy/components/Map/StreetSelectorClient.jsx";
import NumerBudynku from "../../../Admin-DoDostawy/components/Map/NumerBudynkuClient.jsx";
...
function ModalComponent({ isModalVisible, setModalVisible }) {
  ...
  const [restaurantCoordinates, setRestaurantCoordinates] = useState({ lat: 50.04132, lon: 21.99901 });
  ...
  const updateMapCoordinates = async (streetName, house_number) => {
    try {
      ...
      if (error.response && error.response.status === 404) {
        // Обробляємо 404 помилку як відсутність даних, не як помилку
      } else {
  ...
  const fetchRates = async () => {
    try {
      ...
      setRateAbove6km(data[0].rateAbove6km);
      setRateOutsideZone(data[0].rateOutsideZone);
        ...
        <div className="modal-body-1">
            <div className="input-group-3">
              ...
              <MapBoxComponentRoute
                ...
                rzeszowCoordinates={restaurantCoordinates}
