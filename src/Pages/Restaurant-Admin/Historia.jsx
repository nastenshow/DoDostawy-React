...
import HistoriaOrders from "./components/Historia/HistoriaOrders";
    ...
    <div className="order white-rounded-box">
      <div className="row">
        <div className="left-group">
          {/* <div className="group-text">Historia Zamówień</div> */}
        </div>
        ...
        <div className="input-group datepicker-group">
          ...
          <NavLink to="/dashboard-admin-restaurant/rozliczenie">
          ...
          <NavLink to={`/dashboard-admin-restaurant/historia`}>
            <div className="group-botton">
              <FontAwesomeIcon
                icon={faList}
                size="lg"
          ...
          <NavLink to="/dashboard-admin-restaurant/zamowienia">
